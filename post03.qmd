...
The disparities are not spread evenly across this ranking — they concentrate at the top. The widest women pay gaps sit in the best-paid sectors: women earn 23% below men in Investment, 27% below in Hybrid finance, and 27% below in Construction at five years out, each gap widening further by ten years.
...
**The ABMO gaps are partly insecurity.** The mirror image: temporary work is far more common among ABMO workers — Black workers are around 2.5× as likely as white to be in temporary employment — while the sex gap is small. Insecure contracts are a mechanism for the ABMO gaps in a way part-time hours are not.

Each pay gap has its own dominant confounder: hours for women, insecurity for ABMO. None of this makes the gaps disappear. We study as many additional supply and demand factors as the administrative-linked data allow in our [upcoming revision](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4503424), where factors like STEM subject choice, university prestige, distance and job flexibility close the gaps for ABMO graduates but not for women.
