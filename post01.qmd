...
::: {.column-page}
```{=html}
<iframe src="figures/fig_part1_sex.html" width="100%" height="400" style="border:none"></iframe>
```
:::
...
::: {.column-page}
```{=html}
<iframe src="figures/fig_part1_ethnicity.html" width="100%" height="400" style="border:none"></iframe>
```
:::
